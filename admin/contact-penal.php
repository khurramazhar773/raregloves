...
$sqli = "SELECT id, name, email, phone, address, message FROM contact";
			...
			<div class="col-xs-12 col-sm-12 col-md-12">
				<div class="page-title title-1 text-center">
					...
					<ol class="breadcrumb">
						...
						<li>
							<a href="quots-penal.php">Quots</a>
						</li>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading" role="tab" id="headingOne">
                            <h4 class="panel-title">
                                <a class="accordion-toggle" role="button" data-toggle="collapse" data-parent="#accordion02" href="#collapse<?php echo $row['id']; ?>" aria-expanded="true" aria-controls="collapse<?php echo $row['id']; ?>">
                                    <span class="yellow">Request From:</span><span style="text-transform: uppercase;"> <?php echo $row['name']; ?></span>
                                </a>
                        ...
                        <div id="collapse<?php echo $row['id']; ?>" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingOne">
                            <div class="panel-body con-things">
                                <div class="email"><i class="fa-brands fa-google-plus-g" style="color: #005eff;font-size: xx-large;"></i><?php echo $row['email']; ?></div>
                                <div class="phone"><i class="fa fa-phone" style="color: green; font-size: xx-large;"></i> <?php echo $row['phone']; ?></div>
                            </div>
                            <div class="panel-body">
                                <div class="address"><i class="fa fa-map-marker" style="color: red ;font-size: xx-large;"></i> <?php echo $row['address']; ?></div>
                            </div>
                            <div class="panel-body">
