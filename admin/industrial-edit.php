...
$sel = "SELECT p.id, p.product_name, p.description, p.image_url, c.category_name , p.created_at
        FROM products p 
                ...
                <div class="col-xs-12 col-sm-6 col-md-3 project-item <?php echo $row['category_name'] ?>">
                    <div class="project-img">
                        ...
                        <div class="project-hover">
                            <form action="../assets/php/updation.php" method="post" enctype="multipart/form-data">
                            ...
                            <div class="project-zoom">
                                <form action="../assets/php/i-product-del.php" method="POST"
